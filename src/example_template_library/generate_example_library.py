    ...
    def generate_lined_examples(self):
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--spacing", "6mm",
                "--major_every", "5",
                "--filename", "lined_6mm_major_every_5"
            ]),
            category,
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--spacing", "6mm",
                "--line-numbers",
                "--line-numbers-interval", "5",
                "--filename", "lined_with_numbers"
            ]),
            category,
        ...
        self.run_command(
            self.build_cmd([
                "lined",
                "--lines", "40",
                "--filename", "lined_exactly_40_lines"
            ]),
            category,
    ...
    def generate_grid_examples(self):
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--spacing", "5mm",
                "--axis-labels",
                "--axis-labels-interval", "5",
                "--filename", "grid_axis_labels"
            ]),
            category,
    ...
    def generate_dotgrid_examples(self):
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--major_every", "5",
                "--crosshair_size", "6",
                "--filename", "dotgrid_with_crosshairs"
            ]),
            category,
    ...
    def generate_multi_examples(self):
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--rows", "1",
                "--columns", "2",
                "--cell_types", "lined,grid",
                "--spacing", "6mm",
                "--filename", "multi_1x2_lined_grid"
            ]),
            category,
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--rows", "2",
                "--columns", "2",
                "--cell_types", "lined,dotgrid,grid,manuscript",
                "--spacing", "5mm",
                "--filename", "multi_2x2_mixed"
            ]),
            category,
    ...
    def generate_title_examples(self):
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--spacing", "10mm",
                "--truchet-seed", "42",
                "--truchet-variant", "classic",
                "--filename", "title_truchet_classic"
            ]),
            category,
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--spacing", "8mm",
                "--truchet-seed", "123",
                "--truchet-variant", "cross",
                "--filename", "title_truchet_cross"
            ]),
            category,
        ...
        self.run_command(
            self.build_cmd([
                "title",
                "--type", "diagonal_truchet",
                "--spacing", "5mm",
                "--diag-fill-grey1", "0",
                "--diag-fill-grey2", "15",
                "--filename", "title_diagonal"
            ]),
            category,
    ...
    def generate_advanced_examples(self):
        ...
        self.run_command(
            self.build_cmd([
                ...
                "--header-sep", "double",
                "--footer-sep", "dotted",
                "--filename", "lined_with_separators"
            ]),
            category,
    ...
    def create_json_examples(self):
        ...
        cornell_layout = {
            ...
            "page_layout": [
                {
                    "height_ratio": 0.15,
                    "columns": [{"width_ratio": 1.0, "template_type": "blank"}]
                },
                {
                    "height_ratio": 0.75,
                    "columns": [
        ...
        self.run_command(
            self.build_cmd([
                "layout",
                "--file", str(cornell_path),
                "--filename", "layout_cornell_notes"
            ]),
            category,
        ...
        dashboard_layout = {
            ...
            "page_layout": [
                ...
                {
                    "height_ratio": 0.7,
                    "columns": [{"width_ratio": 1.0, "template_type": "lined"}]
                }
            ]
        }
...
def main():
    ...
    parser.add_argument(
        '--device',
        default=DEVICE,
        help=f'Target device for all examples (default: {DEVICE})'
    )
    parser.add_argument(
        '--main-script',
        default=MAIN_SCRIPT,
        help=f'Path to main script (default: {MAIN_SCRIPT})'
    )
    parser.add_argument(
        '--categories',
        nargs='+',
        choices=['lined', 'grid', 'dotgrid', 'specialty', 'multi', 'title', 'advanced', 'json', 'all'],
        default=['all'],
