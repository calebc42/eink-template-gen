...
def _draw_bracket(ctx, x, y, size=20.0, line_width=2.0, corner="top-left", 
                  notch=True, double=False):
    """
...
def _draw_crosshair(ctx, x, y, size=15.0, line_width=1.5, corner="top-left",
                    center_circle=True):
    """
...
def _draw_geometric_frame(ctx, x, y, size=20.0, line_width=1.5, corner="top-left",
                          num_frames=3):
    """
...
def _draw_tech_marker(ctx, x, y, size=18.0, line_width=1.5, corner="top-left",
                      marker_style="arrows"):
    """
...
def _draw_diagonal_stripes(ctx, x, y, size=20.0, line_width=1.5, corner="top-left",
                           num_stripes=4, stripe_gap=4.0):
    """
...
def _draw_corner_node(ctx, x, y, size=12.0, line_width=1.5, corner="top-left",
                      node_style="circuit"):
    """
...
def _draw_pixel_art_corner(ctx, x, y, size=16.0, line_width=1.0, corner="top-left",
                           pattern="blocks"):
    """
