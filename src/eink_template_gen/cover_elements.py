...
def draw_title_element(ctx, page_width, page_height, config, 
                     content_x_start=0, content_y_start=0, 
...
def draw_title_frame(ctx, x_center, y_center, width, height, 
                     shape='rectangle', border_style='solid', 
                     border_width=2.0, border_grey=0,
                     fill_grey=None, corner_radius=10):
    """
...
def draw_title_text(ctx, text, x_center, y_center, 
                    font_family='Serif', font_size=48,
                    font_weight='bold', font_slant='normal',
                    text_grey=0, letter_spacing=0):
    """
