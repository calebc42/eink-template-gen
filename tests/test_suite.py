...
class TestUtilityFunctions:
    ...
    def test_parse_spacing_px_mode(self):
        ...
        assert adjusted == False  # No adjustment in px mode
...
class TestTemplateGeneration:
    ...
    def test_all_template_types(self, standard_device):
        ...
        template_types = [t for t in TEMPLATE_REGISTRY.keys() 
                         if t != 'hybrid_lined_dotgrid']
...
class TestPixelPerfection:
    ...
    def test_spacing_is_integer_pixels(self, standard_device):
        ...
        for spacing_mm in [2, 4, 6, 8, 10]:
            ...
            assert spacing_px == round(spacing_px), \
    ...
    def test_margin_adjustment_eliminates_gaps(self):
        ...
        top, bottom = calculate_adjusted_margins(
            content_height, spacing_px, base_margin
        )
...
class TestSeparators:
    ...
    def test_all_separator_styles(self, standard_device):
        ...
        for style in styles:
            ...
            assert isinstance(surface, cairo.ImageSurface), \
                f"Failed with separator style: {style}"
...
class TestPerformance:
    ...
    def test_multiple_generations(self, standard_device):
        ...
        assert avg_time < 1.0, \
            f"Average generation time {avg_time:.2f}s, expected < 1s"
