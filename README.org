...
|---|---|
| [[file:src/assets/screenshots/before/problem_before_blurry_lines.png]] | [[file:src/assets/screenshots/problem_after_pixel_perfect_lined.png]] |
...
|---|---|
| [[file:src/assets/screenshots/before/problem_before_grid_alignment.png]] | [[file:src/assets/screenshots/problem_after_grid_alignment.png]] |
...
|---|---|---|
| [[file:src/assets/screenshots/gallery_lined_with_numbers.png]] | [[file:src/assets/screenshots/gallery_dotgrid_with_crosshairs.png]] | [[file:src/assets/screenshots/gallery_grid_with_axis_labels.png]] |
| *Manuscript* | *French Ruled* | *Music Staff* |
| [[file:src/assets/screenshots/gallery_manuscript.png]] | [[file:src/assets/screenshots/gallery_french_ruled.png]] | [[file:src/assets/screenshots/gallery_music_staff.png]] |
| *Isometric* | *Hex Grid* | *Hybrid* |
| [[file:src/assets/screenshots/gallery_isometric.png]] | [[file:src/assets/screenshots/gallery_hexgrid.png]] | [[file:src/assets/screenshots/gallery_hybrid.png]] |
...
|---|---|---|---|
| [[file:src/assets/screenshots/layout_multi_uniform.png]] | [[file:src/assets/screenshots/layout_multi_vertical.png]] | [[file:src/assets/screenshots/layout_multi_mixed.png]] | [[file:src/assets/screenshots/layout_json_cornell.png]] |
...
|---|---|---|
| [[file:src/assets/screenshots/title_truchet_filled.png]] | [[file:src/assets/screenshots/title_diagonal_truchet.png]] | [[file:src/assets/screenshots/title_hexagonal_truchet.png]] |
| *10 Print* | *Koch Snowflake* | *Plant Fractal* |
| [[file:src/assets/screenshots/title_ten_print.png]] | [[file:src/assets/screenshots/title_lsystem_koch.png]] | [[file:src/assets/screenshots/title_lsystem_plant.png]] |
| *Contour Lines* | *Noise Field* | *Title w/ Frame* |
| [[file:src/assets/screenshots/title_contour_lines.png]] | [[file:src/assets/screenshots/title_noise_field.png]] | [[file:src/assets/screenshots/title_with_frame.png]] |
...
[[file:src/assets/screenshots/custom_separators.png]]
