...
def create_truchet_title(width, height, dpi, spacing_mm, margin_mm,
                         line_width_px,
    ...
    # Draw Truchet tiles
    draw_truchet_tiles(ctx, m_left, width - m_right,
    ...
    if decorative_border:
        draw_decorative_border(ctx, m_left, width - m_right,
                              m_top, height - m_bottom,
...
def _draw_title_element(ctx, page_width, page_height, config):
    ...
    """
    # --- MODIFIED: Vertical Alignment Logic ---
    ...
    if config.get('show_frame', True):
        draw_title_frame(
            ctx, x_center, y_center, frame_width, frame_height,
...
def create_diagonal_truchet_title(width, height, dpi, spacing_mm, margin_mm,
    ...
    draw_diagonal_truchet_tiles(ctx, m_left, width - m_right,
                                m_top, height - m_bottom,
                                spacing_px,
                                rotation_seed=rotation_seed,
...
# --- NEW: Hexagonal Truchet Title Generator ---

def create_hexagonal_truchet_title(width, height, dpi, spacing_mm, margin_mm,
                                   line_width_px,
                                   header_separator=None, footer_separator=None,
                                   rotation_seed=None,
                                   auto_adjust_spacing=True,
    ...
    draw_hexagonal_truchet_tiles(ctx, m_left, width - m_right,
                                 m_top, height - m_bottom,
                                 spacing_px, line_width_px,
                                 rotation_seed=rotation_seed)
...
def create_10_print_title(width, height, dpi, spacing_mm, margin_mm,
                           line_width_px,
                           header_separator=None, footer_separator=None,
                           rotation_seed=None,
                           auto_adjust_spacing=True,
    ...
    # Draw 10 PRINT tiles
    draw_10_print_tiles(ctx, m_left, width - m_right,
                        m_top, height - m_bottom,
                        spacing_px, line_width_px,
                        rotation_seed=rotation_seed)
...
def create_lsystem_title(width, height, dpi, spacing_mm, margin_mm,
                         line_width_px,
                         header_separator=None, footer_separator=None,
                         auto_adjust_spacing=True,
                         title_config=None,
    ...
    # --- IMPROVED: Calculate Step Length ---
    ...
    draw_lsystem_pattern(ctx, lsystem_config, 
                         x_start, y_start, 
...
def create_contour_lines_title(width, height, dpi, spacing_mm, margin_mm,
                                line_width_px,
                                header_separator=None, footer_separator=None,
                                auto_adjust_spacing=True,
                                title_config=None,
    ...
    # Draw contour lines
    draw_contour_lines(ctx, m_left, width - m_right,
                      m_top, height - m_bottom,
...
def create_noise_field_title(width, height, dpi, spacing_mm, margin_mm,
    ...
    # Draw noise field
    draw_noise_field(ctx, m_left, width - m_right,
                    m_top, height - m_bottom,
                    noise_scale=noise_scale,
                    octaves=octaves,
                    seed=noise_seed,
